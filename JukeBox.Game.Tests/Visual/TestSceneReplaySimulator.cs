...
namespace JukeBox.Game.Tests.Visual
{
    ...
    public partial class TestSceneReplaySimulator : JukeBoxTestScene
    {
        ...
        /// mounted and no 16ms simulation steps — a whole map in milliseconds. It is OFF by default
        /// (the drawable renderer is the exact, shipping path), so this enables it explicitly and
        /// asserts the absence of renderer and steps, guarding the analytic path itself.
        /// </summary>
        [Test]
