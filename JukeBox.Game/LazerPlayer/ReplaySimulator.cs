...
public partial class ReplaySimulator : CompositeDrawable
{
    ...
    /// <summary>
    /// Test seam: force the drawable simulation even for an osu map. Only the cross-validation test
    /// sets it, to get lazer's real gameplay as the oracle the analytic judge is checked against.
    /// </summary>
