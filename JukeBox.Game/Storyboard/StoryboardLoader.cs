...
/// single Z-ordered object list, ready to hand to a Core StoryboardUpdater. Pure CPU work with
/// no framework dependency — call this off the update thread (e.g. from a BackgroundDependencyLoader).
/// </summary>
